...
# Prerequisites:
#   - git installed
#   - Your fork cloned locally: git clone https://github.com/Exhipper/NFX-Puke-Kicker.git
#
set -euo pipefail

FORK_URL="https://github.com/Exhipper/NFX-Puke-Kicker.git"
ARCHIVE="nfx-puke-kicker-webapp.tar.gz"
CLONE_DIR="NFX-Puke-Kicker"

echo "=== NFX Puke Kicker — Push Web App to Fork ==="
echo ""
...
git commit -m "Add NFX Puke Kicker web app (React + Express)
...
- Features: puke checking, proxy support, nfToken generation,
...
echo "  https://github.com/Exhipper/NFX-Puke-Kicker/pull/new/$WEB_BRANCH"
echo ""
