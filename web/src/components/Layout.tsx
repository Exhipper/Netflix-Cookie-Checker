...
const navItems = [
  ...
  { to: "/checker", label: "Kicker", icon: ScanLine },
    ...
    <div className="min-h-screen bg-background bg-grid">
      ...
      <aside className="fixed inset-y-0 left-0 z-50 hidden w-64 flex-col border-r border-border bg-sidebar lg:flex">
        <div className="flex h-16 items-center gap-2 border-b border-border px-6">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-sm font-semibold text-foreground">Puke Kicker</div>
              <div className="text-xs text-muted-foreground">NFX Puke Kicker v4.5</div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border p-4">
          <div className="text-xs text-muted-foreground">
            Forked from{" "}
            <a
              href="https://github.com/Exhipper/NFX-Puke-Kicker"
              target="_blank"
      ...
      <div className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-border bg-background/80 px-4 backdrop-blur-sm lg:hidden">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold">Puke Kicker</span>
        </div>
